            ...
            Function<CreateIndexRequest.Builder, ObjectBuilder<CreateIndexRequest>> request = builder ->
                    builder.index(indexName)
                            ...
                            .mappings(m -> m
                                    ...
                                    .properties(ProductDocument.Fields.createTime, p -> p.date(d -> d.format("strict_date_optional_time||yyyy-MM-dd HH:mm:ss||epoch_millis")))
                                    .properties(ProductDocument.Fields.updateTime, p -> p.date(d -> d.format("strict_date_optional_time||yyyy-MM-dd HH:mm:ss||epoch_millis")))
                            );
